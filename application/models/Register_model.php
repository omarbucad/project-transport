...
//            "ip_address" => $this->input->ip_address() ,
    ...
    public function signin($user){
        ...
        $this->db->select("s.store_name, s.logo_image_path, s.logo_image_name,s.trial_used, a1.*, up.plan_expiration, up.user_plan_id, up.subscription_id, up.vehicle_limit, up.billing_type, p.planId, p.title");
