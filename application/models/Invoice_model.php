...
class Invoice_model extends CI_Model {
    ...
    public function get_invoice($invoice_id){
        ...
        $this->db->select("i.*, up.plan_created, up.plan_expiration, up.billing_type, up.who_updated, u2.display_name as updated_by, u.user_id, u.display_name,u.email_address,s.store_name, sa.*,p.*");
    ...
    public function user_invoice($user_id){
        ...
        $this->db->select("i.*, up.plan_created, up.plan_expiration, up.billing_type, up.who_updated, u2.display_name as updated_by, u.display_name,u.email_address,s.store_name, sa.*, p.*");
