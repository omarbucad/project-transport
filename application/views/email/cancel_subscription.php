...
<body style="width: 100%">
	<table style="width: 100%;" cellpadding="0">
		<tr style="margin: 10px auto; padding: 20% auto;">
			...
			<div class="container">
				<p><strong>Your cancellation subscription confirmation</strong></p>
				<p class="help-block">You've cancelled you r premium plan subscription which will end <?php echo $expiration; ?></p>
				<p>When your subscription ends, you will start with a free account again, and some features will no longer be available.</p>
				<p>If you want to come back, you can upgrade your account to <strong>premium</strong> at any time. </p>
