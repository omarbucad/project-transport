	...
	<table style="width: 100%;" cellpadding="0">
		<tr style="margin: 10px auto; padding: 20% auto;">
			...
			<div class="container">
				...
				<p>Plan<br>Premium plan of <?php echo $quantity; ?> vehicle(s)</p>
				<p>Plan price<br>$<?php echo $price; ?>/<?php echo $billing_type; ?></p>
				
				<?php if($payment_type == 'CARD') : ?>
					<p><span>Payment</span><br><span><?php echo $payment_type; ?></span><br>
						<span>Card No: <?php echo $card; ?></span><br>
						<span>EXP: <?php echo $expiration;?></span>
					</p>
