                    ...
                    <div class="row">
                        <div class="col-lg-6 no-margin-bottom">
                            ...
                            <div class="div-upload <?php echo (isset($row['image_path']) && $row['image_path'] != '') ? 'hidden':''; ?>">
                               ...
                               <!--  <form action="<?php //echo site_url('app/setup/upload_item_image/').$row['id'];?>" class="uploader" method="POST" enctype="multipart/form-data" "> -->
                                    <input type="hidden" name="checklistid" value="<?php echo $this->hash->encrypt($result->checklist_id);?>">
                                    <input type="file" name="file" class="item-file" id="file_<?php echo $row['id']; ?>">
