...
<body>
	...
	<div class="row" style="margin: 0,10px,10px,20px;">
		<table style="width: 100%;">
			<tr>
				<td style="width:350px;">
					...
					<p style="width: 100px;margin-left: 15px;margin-bottom: 0;font-size: 10px; margin-top: 0;">Mobile Number: <?php echo $phone; ?></p>
					<p style="width: 100px;margin-left: 15px;margin-top: 0;font-size: 10px;">E-mail: <?php echo $email_address; ?></p>
				</td>
				<td style="width: 400px;">
					<div style="border: 1px solid #DCDBDB;padding: 10px;margin-left:20px;margin-right: 19px; font-size: 10px; background-color: #DCDBDB;">
						...
						<table style="padding-left: 20px;padding-right: 20px;margin-top: 8px;">
							<tr>
								<td>Vehicle Type: </td>
								<td style="text-align: right;padding-left: 10px;"><?php echo $type; ?></td>
								<td style="padding-left: 50px;">Start Mileage: </td>
								<td style="text-align: right;padding-left: 10px;"><?php echo $start_mileage; ?></td>
							</tr>
							<tr>
								<td>Registration No: </td>
								<td style="text-align: right;padding-left: 10px;"><?php echo $vehicle_registration_number; ?></td>
								<td style="padding-left: 50px;">End Mileage: </td>
								<td style="text-align: right;padding-left: 10px;"><?php echo ($end_mileage != '') ? $end_mileage : ""; ?></td>
							</tr>
							<tr>
								<?php if(isset($trailer_number)) : ?>
								<td>Trailer No: </td>
								<td style="text-align: right;padding-left: 5px;"><?php echo ($trailer_number == '')? "N/A" : $trailer_number; ?></td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<?php else: ?>
								<td>&nbsp;</td>
		...
		<?php 
			$first_half = array_slice($report_checklist, 0, 27,true);
			$second_half = array_slice($report_checklist, 27,27,true);
		?>

		<?php if(count($report_checklist) > 28) : ?>
		...
		<div class="row" style="width: 748px;border: 1px solid #DCDBDB; font-size: 9px;">
			<table style="padding: 10px;">
				<tr>
					...
					<td style="padding-left: 130px;">Role: <?php echo $role;?></td>
				</tr>
				<tr>
