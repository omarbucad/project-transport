        ...
        <div class="card margin-bottom">
            <div class="container">
                <div class="card-body no-padding-left no-padding-right">
                    <form action="<?php echo site_url("app/report/"); ?>" method="GET" id="search-filter">
                        <div class="row">
                        ...
                        <tr class="customer-row" style="cursor: default;">
                            <td valign="top">
                              <span><strong><a href="<?php echo site_url('app/report/view/').$this->hash->encrypt($row->report_id);?>" class="link-style"><?php echo $row->report_number; ?></a></strong> 
                                ...
                                <small class="help-block">Report by: <?php echo $row->display_name; ?></small>
                                <small class="help-block">Vehicle: <?php echo $row->vehicle_registration_number; ?></small>
                                <?php if(isset($row->trailer_number)) : ?>
                                <small class="help-block">Trailer: <?php echo $row->trailer_number; ?></small>
                                <?php endif; ?>
                              </span>
