                    ...
                    <div class="col-xs-12 col-lg-5 no-margin-bottom color-white">
                        <div class="row">
                            <div class="col-xs-12 col-lg-6no-margin-bottom text-center color-white>
                                <h2 style="margin-bottom: 0;"><a href="<?php echo site_url();?>"><img src="<?php echo site_url("public/img/vehicle-checklist.png"); ?>" class="img img-responsive" alt="Vehicle Checklist Logo" style="width: 39%; position: relative;left: 30%;margin-top:10px;margin-bottom: 10px;"></a><span style="font-size: 26px;">Vehicle Checklist</span></h2> 
